...
# ======================================================================================================================
readonly YOUR_USERNAME=""
readonly ADMIN_USERNAME=""
readonly ADMIN_PASSWORD=""
readonly YOUR_IP=""
readonly YOUR_IP_MASQUE=""
...
readonly PHPMYADMIN_URL="https://files.phpmyadmin.net/phpMyAdmin/${PHPMYADMIN_VERSION}/phpMyAdmin-${PHPMYADMIN_VERSION}-all-languages.tar.xz"
